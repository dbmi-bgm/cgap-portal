...
def load_items(env, json_input, itypes=None, key=None, secret=None, patch_only=False):
    """
    ...
    json_data = {'config_uri': config_uri, 'overwrite': True, 'iter_response': True, 'patch_only': patch_only}
    if itypes:
