...
TEST_VCF = './src/encoded/tests/data/variant_workbook/test_vcf.vcf'
EXPECTED_ANNOTATION_FIELDS = ['MUTANNO', 'VEP', 'CYTOBAND', 'UNIPROT_TRANSMEM',
                              'DBSNP', 'CONSERVATION', 'PRIMATEAI', 'CADD',
                              'SPLICEAI', 'MAX_POP_AF', 'GNOMAD', 'TOPMED',
                              'UK10K', 'GENOMIC_SUPER_DUPLICATES',  'SIMPLE_REPEAT',
                              'RMSK',  'NESTED_REPEATS',  'MICROSATELLITE',  'CLINVAR',  'COSMIC',]
VARIANT_SCHEMA = './src/encoded/tests/data/variant_workbook/variant.json'
VARIANT_SAMPLE_SCHEMA = './src/encoded/tests/data/variant_workbook/variant_sample.json'
