...
class Cohort(Item):
    ...
    embedded_list = [
        ...
        "families.members.samples.specimen.specimen_type",
        "families.members.samples.specimen.specimen_notes",
        "families.members.samples.specimen.specimen_collection_date",
