...
def build_variant_sample_embedded_list():
    ...
    embedded_list = [
        ...
        "variant_note.classification",
        "variant_note.acmg_guidelines",
        "variant_note.conclusion",
        "variant_note.note_text",
        "variant_note.version",
        "variant_note.project",
        "variant_note.institution",
        "variant_note.status",
        "gene_note.classification",
        "gene_note.acmg_guidelines",
        "gene_note.conclusion",
        "gene_note.note_text",
        "gene_note.version",
        "gene_note.project",
        "gene_note.institution",
        "gene_note.status",
        "interpretation.classification",
        "interpretation.acmg_guidelines",
        "interpretation.conclusion",
