...
export default class App extends React.PureComponent {
    ...
    render() {
        ...
        const contentSecurityPolicyStr = [
            ...
            "script-src 'self' https://www.google-analytics.com https://cdn.auth0.com https://hms-dbmi.auth0.com https://secure.gravatar.com 'unsafe-eval'", // + (typeof BUILDTYPE === "string" && BUILDTYPE === "quick" ? " 'unsafe-eval'" : ""),
