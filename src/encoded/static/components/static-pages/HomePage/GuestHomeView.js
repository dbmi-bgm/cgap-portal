        ...
        <React.Fragment>
            <div className="homepage-contents">
                <div className="d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div className="cgap-tagline text-center px-2 text-small pt-1">
                        The{' '}
                        <strong>
                            Computational Genome Analysis Platform (CGAP)
                        </strong>{' '}
                        is an intuitive, open-source analysis tool designed to
                        support complex research &amp; clinical genomics
                        workflows.
                    </div>
                    <LoginController
                        {...{ updateAppSessionState, auth0Options }}>
                        <LoginBox className="mt-25" session={session} />
                    </LoginController>
                    <div className="cgap-links text-primary text-small mt-2 mb-5 row">
                        <div className="text-600 pr-sm-1 col-12 col-sm-auto text-center">
                            <a href="https://cgap.hms.harvard.edu">
                                CGAP Homepage
                            </a>
                        </div>
                        <div className="text-600 pl-sm-1 pr-sm-1 border-primary col-12 col-sm-auto text-center">
                            <a href="https://cgap-training.hms.harvard.edu/help/logging-in#section1">
                                Account Setup Guide
                            </a>
                        </div>
                        <div className="text-600 pl-sm-1 col-12 col-sm-auto text-center">
                            <a href="https://www.youtube.com/@cgaptraining">
                                Video Tutorials
                            </a>
                        </div>
                    </div>
...
const LoginBox = React.memo(function LoginBox(props) {
    const { showLock, isAuth0LibraryLoaded, unverifiedUserEmail, session } =
        props;
