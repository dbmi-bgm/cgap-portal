...
export class CGAPLogoText extends React.PureComponent {
    render() {
        const { color = "#d2dadf", hover } = this.props;
        return (
            <svg id="a" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 91.05 25.06" width={98}>
                <defs>
                    <style>
                        {`.lb { fill:${ hover ? "#ffffff": color}; }`}
                    </style>
                </defs>
                <path class="lb" d="M16.06,20.55c-1.03,.45-2.29,.68-3.78,.68-1.21,0-2.31-.21-3.31-.63-1-.42-1.86-1.01-2.59-1.79-.73-.78-1.29-1.7-1.69-2.77-.39-1.07-.59-2.24-.59-3.52s.2-2.45,.59-3.52c.39-1.07,.96-1.99,1.69-2.77,.73-.78,1.59-1.37,2.59-1.79,1-.42,2.1-.63,3.31-.63,1.37,0,2.57,.22,3.6,.66,1.03,.44,1.91,1.06,2.63,1.84l2.71-2.71c-1.11-1.11-2.39-2-3.83-2.65-1.44-.65-3.14-.97-5.12-.97-1.76,0-3.39,.33-4.89,.97-1.5,.65-2.8,1.54-3.92,2.68-1.11,1.14-1.97,2.47-2.58,3.98-.6,1.52-.91,3.15-.91,4.89s.3,3.37,.91,4.89c.6,1.52,1.46,2.85,2.58,4,1.11,1.15,2.42,2.04,3.92,2.68,1.5,.64,3.13,.96,4.89,.96,1.95,0,3.68-.33,5.19-.97,1.51-.65,2.82-1.54,3.93-2.68l-2.71-2.71c-.72,.79-1.6,1.41-2.63,1.86Z"/>
                <path class="lb" d="M34.87,15.17h7.75c-.15,.94-.4,1.79-.79,2.52-.63,1.17-1.53,2.05-2.7,2.65-1.17,.59-2.57,.89-4.19,.89-1.53,0-2.9-.37-4.11-1.11-1.21-.74-2.16-1.77-2.87-3.08-.71-1.31-1.06-2.82-1.06-4.54s.35-3.22,1.04-4.52c.7-1.3,1.68-2.31,2.94-3.05,1.26-.73,2.73-1.1,4.4-1.1,1.39,0,2.69,.27,3.9,.82,1.21,.55,2.17,1.33,2.89,2.35l2.71-2.71c-1.11-1.37-2.49-2.42-4.14-3.17-1.65-.74-3.43-1.11-5.36-1.11-1.76,0-3.41,.32-4.92,.96-1.52,.64-2.84,1.53-3.97,2.68-1.13,1.15-2.01,2.48-2.64,3.98-.64,1.51-.96,3.13-.96,4.87s.32,3.37,.96,4.89c.64,1.52,1.51,2.85,2.63,4,1.11,1.15,2.41,2.05,3.9,2.7,1.48,.65,3.06,.97,4.73,.97,2.3,0,4.34-.48,6.13-1.43,1.79-.95,3.2-2.39,4.23-4.32,1.03-1.93,1.55-4.34,1.55-7.24v-.56h-12.04v3.65Z"/>
                <path class="lb" d="M57.98,.35l-10.02,24.36h4.25l1.87-4.7h10.47l1.86,4.7h4.32L60.77,.35h-2.78Zm-2.52,16.18l3.87-9.71,3.84,9.71h-7.71Z"/>
                <path class="lb" d="M89.99,3.93c-.71-1.14-1.67-2.02-2.89-2.65s-2.59-.94-4.12-.94h-9.05V24.71h4V15.52h5.05c1.53,0,2.91-.31,4.12-.94,1.22-.63,2.18-1.51,2.89-2.65,.71-1.14,1.06-2.47,1.06-4s-.35-2.87-1.06-4Zm-3.5,6.18c-.37,.62-.88,1.09-1.51,1.43-.64,.34-1.37,.5-2.21,.5h-4.84V3.83h4.84c.84,0,1.57,.17,2.21,.5,.64,.34,1.14,.81,1.51,1.43,.37,.62,.56,1.34,.56,2.18s-.19,1.56-.56,2.18Z"/>
            </svg>
        )
    }
}
