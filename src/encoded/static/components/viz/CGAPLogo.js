...
export class CGAPLogo extends React.PureComponent {
    ...
    constructor(props) {
        super(props);
        this.setHoverStateOnDoTiming = _.throttle(
            this.setHoverStateOnDoTiming.bind(this),
            1000
        );
    ...
    render() {
        ...
        const outerStyle = {
            ...(hover ? svgElemStyleHover : svgElemStyle),
            maxHeight,
            width: maxHeight,
        };
        ...
        return (
            <div
                ...
                onClick={onClick}
                onMouseEnter={this.setHoverStateOn}
                onMouseLeave={this.setHoverStateOff}>
                <svg
                    id={id}
                    ref={this.svgRef}
                    style={outerStyle}
                    ...
                    <g transform={groupTransform}>
                        <path
                            d="m 81.314453,24.175781 3.75,7.5 h 10.796875 l -3.71875,-7.5 z"
                            style={style1}
                            className="path-g-1"
                        />
                        <path
                            d="M 61.289062,4.3085938 55.621094,11.865234 84.261719,31.1875 80.705078,24.072266 Z"
                            style={style1}
                            className="path-g-1"
                        />
                        <path
                            d="M 0.66992188,4.5 4.3886719,12 h 9.8261721 l -3.75,-7.5 z"
                            style={style1}
                            className="path-g-2"
                        />
                        <path
                            d="m 11.253906,4.9628906 3.570313,7.1367184 20.412109,19.773438 5.669922,-7.558594 z"
                            style={style1}
                            className="path-g-2"
                        />
                        <path
                            d="M -0.56835938,19.923931 7.1035156,35.173892 H 25.59375 L 17.865234,19.923828 Z"
                            style={style2}
                            className="path-g-1"
                        />
                        <path
                            d="m 35.765625,4.1757812 5.625,7.4999998 h 13.748047 l 5.625,-7.4999998 z"
                            style={style2}
                            className="path-g-1"
                        />
                        <path
                            d="M 35.230469,4.296875 18.328125,19.728516 26.039062,34.94147 40.958984,11.933594 Z"
                            style={style2}
                            className="path-g-1"
                        />
                        <path
                            d="m 41.390625,24.5 -5.625,7.5 h 25 l -5.625,-7.5 z"
                            style={style2}
                            className="path-g-2"
                        />
                        <path
                            d="M 70.488281,1.25 55.570312,24.240234 61.300781,31.878906 78.205078,16.443359 Z"
                            style={style2}
                            className="path-g-2"
                        />
                        <path
                            d="m 70.921875,1 7.746094,15.25 H 97.109375 L 89.423828,1 Z"
                            style={style2}
                            className="path-g-2"
                        />
                    </g>
