...
export class SelectedNodeController extends React.PureComponent {
    ...
    componentDidUpdate(pastProps) {
        ...
        if (objectGraph !== pastObjGraph) {
            ...
            this.setState(({ currSelectedNodeId }) => {
                ...
                const selectedNode =
                    currSelectedNodeId &&
                    this.memoized.findSelectedNode(
                        objectGraph,
                        currSelectedNodeId
                    );
                if (!selectedNode) {
    ...
    render() {
        ...
        const selectedNode = this.memoized.findSelectedNode(
            objectGraph,
            currSelectedNodeId
        );
        const hoveredNode = this.memoized.findHoveredNode(
            objectGraph,
            currHoverNodeId
        );
        const childProps = {
