 ...
 */
export const ExternalDatabasesSection = React.memo(
    function ExternalDatabasesSection(props) {
        const {
            currentItem,
            schemas = null,
            itemType = 'Gene',
        ...
        const externalDatabaseSchemaFields = externalDatabaseFieldnames
            .map(function (fieldName) {
                let propertySchema = schemaTransforms.getSchemaProperty(
                    fieldName,
                    schemas,
                    itemType
                );
        ...
        let externalDatabaseElems = externalDatabaseSchemaFields.map(function ([
            fieldName,
            fieldSchema,
        ]) {
            const {
            ...
            if (extIDsLen === 0) {
                val = (
                    <em data-tip="Not Available" className="px-1">
                        {' '}
                        -{' '}
                    </em>
                );
                ...
                val = externalIDs.map(function (externalID) {
                    ...
                    return (
                        <a
                            ...
                            id={'external_resource_for_' + fieldName}
                            key={externalID}>
            ...
            return (
                <div className="row mb-03" key={fieldName}>
                    <div className="col-12 col-lg">
                        <label
                            className="mb-0 black-label"
                            htmlFor={'external_resource_for_' + fieldName}>
                            {schemaTitle || fieldName}
                            {schemaDescription ? (
                                <i
                                    className="icon icon-info-circle fas icon-fw ml-02 icon-sm"
                                    data-tip={schemaDescription}
                                />
                            ) : null}
                        </label>
                    </div>
                    <div className="col-12 col-lg-auto">{val}</div>
                </div>
            );
        });

        // Merge with any custom-rendered items.
        externalDatabaseElems = prependItems
            .concat(externalDatabaseElems)
            .concat(appendItems);

        const externalDatabaseElemsLen = externalDatabaseElems.length;
        if (externalDatabaseElemsLen === 0) {
            return (
                <h4 className="text-center font-italic text-400 my-0 pb-08">
            ...
            return (
                <div className="row">
                    <div className="col-12 col-xl-6">{col1}</div>
                    <div className="col-12 col-xl-6">{col2}</div>
                </div>
            );
        } else {
...
export const GeneOverview = React.memo(function GeneOverview(props) {
    ...
    const aliasSymbolRendered =
        alias_symbol.length === 0 ? <em> - </em> : alias_symbol.join(', ');
    const prevSymbolRendered =
        prev_symbol.length === 0 ? <em> - </em> : prev_symbol.join(', ');
        ...
        <React.Fragment>
            <div className="row mb-03">
                <div className="col-12 col-xl-3">
                    <label
                        htmlFor="variant.transcript.csq_gene.name"
                        className="mb-0">
                        Gene Name:{' '}
                        <i
                            className="icon icon-info-circle fas icon-fw ml-02 icon-sm"
                ...
                <div
                    ...
                    id="variant.transcript.csq_gene.name">
                    {name}
                </div>
            </div>
            ...
            <div className="row mb-03">
                <div className="col-12 col-xl-3">
                    <label
                        htmlFor="variant.transcript.csq_gene.gene_symbol"
                        className="mb-0">
                        Symbol:{' '}
                        <i
                            className="icon icon-info-circle fas icon-fw ml-02 icon-sm"
                ...
                <div
                    className="col-12 col-xl-9"
                    id="variant.transcript.csq_gene.gene_symbol">
                    {gene_symbol}
                </div>
            </div>
            ...
            <div className="row mb-03">
                <div className="col-12 col-xl-3">
                    <label
                        htmlFor="variant.transcript.csq_gene.todo1"
                        className="mb-0"
                        data-tip={null}>
                        Gene Location:
                    </label>
                ...
                <div
                    className="col-12 col-xl-9"
                    id="variant.transcript.csq_gene.todo1">
                    {geneLocation}
                </div>
            </div>
            ...
            <div className="row mb-03">
                <div className="col-12 col-xl-3">
                    <label
                        htmlFor="variant.transcript.csq_gene.gene_biotype"
                        className="mb-0">
                        Gene Type:{' '}
                        <i
                            className="icon icon-info-circle fas icon-fw ml-02 icon-sm"
                ...
                <div
                    className="col-12 col-xl-9"
                    id="variant.transcript.csq_gene.gene_biotype">
            ...
            <div className="row mb-03">
                <div className="col-12 col-xl-3">
                    <label
                        htmlFor="variant.transcript.csq_gene.alias_symbol"
                        className="mb-0"
                        data-tip={null}>
                        Alias Symbol:
                    </label>
                ...
                <div
                    className="col-12 col-xl-9"
                    id="variant.transcript.csq_gene.alias_symbol">
                    {aliasSymbolRendered}
                </div>
            </div>
            ...
            <div className="row mb-03">
                <div className="col-12 col-xl-3">
                    <label
                        htmlFor="variant.transcript.csq_gene.prev_symbol"
                        className="mb-0"
                        data-tip={null}>
                        Previous Symbol:
                    </label>
                ...
                <div
                    className="col-12 col-xl-9"
                    id="variant.transcript.csq_gene.prev_symbol">
                    {prevSymbolRendered}
                </div>
            </div>
            ...
            <div className="row mb-03">
                <div className="col-12 col-xl-3">
                    <label
                        htmlFor="variant.transcript.csq_gene.todo3"
                        className="mb-0"
                        data-tip={null}>
                        Alias Names:
                    </label>
                ...
                <div
                    className="col-12 col-xl-9"
                    id="variant.transcript.csq_gene.todo3">
                    {alias_name}
                </div>
            </div>
            ...
            <div className="row mb-03">
                <div className="col-12 col-xl-3">
                    <label
                        htmlFor="variant.transcript.csq_gene.gene_summary"
                        className="mb-0">
                        Gene Summary:{' '}
                        <i
                            className="icon icon-info-circle fas icon-fw ml-02 icon-sm"
                ...
                <div
                    className="col-12 col-xl-9"
                    id="variant.transcript.csq_gene.gene_summary">
                    {gene_summary}
                </div>
            </div>
        </React.Fragment>
...
export const ConstraintScoresSection = React.memo(
    function ConstraintScoresSection({ currentGeneItem, getTipForField }) {
        const fallbackNotPresent = <em data-tip="Not Available"> - </em>;
        const fallbackNotImplemented = (
            <em data-tip="Not present or implemented"> &bull; </em>
        );
        const {
            exp_lof,
            exp_mis,
                ...
                <tbody>
                    <tr>
                        <td className="text-600 text-left">
                            ...
                            <QuickPopover
                                popID="gene_exp"
                                className="p-0 icon-sm ml-02">
                                {genePopoverContents.expected}
                            </QuickPopover>
                        </td>
                        <td>
                            <span data-tip={getTipForField('exp_syn')}>
                                {falsyZeroCheck(exp_syn, fallbackNotPresent)}
                            </span>
                        </td>
                        <td>
                            <span data-tip={getTipForField('exp_mis')}>
                                {falsyZeroCheck(exp_mis, fallbackNotPresent)}
                            </span>
                        </td>
                        <td>
                            <span data-tip={getTipForField('exp_lof')}>
                                {falsyZeroCheck(exp_lof, fallbackNotPresent)}
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td className="text-600 text-left">
                            ...
                            <QuickPopover
                                popID="gene_obs"
                                className="p-0 icon-sm ml-02">
                                {genePopoverContents.observed}
                            </QuickPopover>
                        </td>
                        <td>
                            <span data-tip={getTipForField('obs_syn')}>
                                {falsyZeroCheck(obs_syn, fallbackNotPresent)}
                            </span>
                        </td>
                        <td>
                            <span data-tip={getTipForField('obs_mis')}>
                                {falsyZeroCheck(obs_mis, fallbackNotPresent)}
                            </span>
                        </td>
                        <td>
                            <span data-tip={getTipForField('obs_lof')}>
                                {falsyZeroCheck(obs_lof, fallbackNotPresent)}
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td className="text-600 text-left">
                            ...
                            <QuickPopover
                                popID="gene_oerange"
                                className="p-0 icon-sm ml-02">
                                {genePopoverContents.oerange}
                            </QuickPopover>
                        </td>
                        <td>
                            <span data-tip={getTipForField('oe_syn')}>
                                {falsyZeroCheck(
                                    shortenToSignificantDigits(oe_syn),
                                    fallbackNotPresent
                                )}
                            </span>
                            {oe_syn_lower !== null && oe_syn_upper !== null
                                ? ` (${oe_syn_lower} - ${oe_syn_upper})`
                                : null}
                        </td>
                        <td>
                            <span data-tip={getTipForField('oe_mis')}>
                                {falsyZeroCheck(
                                    shortenToSignificantDigits(oe_mis),
                                    fallbackNotPresent
                                )}
                            </span>
                            {oe_mis_lower !== null && oe_mis_upper !== null
                                ? ` (${oe_mis_lower} - ${oe_mis_upper})`
                                : null}
                        </td>
                        <td>
                            <span data-tip={getTipForField('oe_lof')}>
                                {falsyZeroCheck(
                                    shortenToSignificantDigits(oe_lof),
                                    fallbackNotPresent
                                )}
                            </span>
                            {oe_lof_lower !== null && oe_lof_upper !== null
                    ...
                    <tr>
                        <td className="text-600 text-left">
                            ...
                            <QuickPopover
                                popID="gene_zscore"
                                className="p-0 icon-sm ml-02">
                                {genePopoverContents.zscore}
                            </QuickPopover>
                        </td>
                        <td>
                            <span data-tip={getTipForField('syn_z')}>
                                {falsyZeroCheck(
                                    shortenToSignificantDigits(syn_z),
                                    fallbackNotPresent
                                )}
                            </span>
                        </td>
                        <td>
                            <span data-tip={getTipForField('mis_z')}>
                                {falsyZeroCheck(
                                    shortenToSignificantDigits(mis_z),
                                    fallbackNotPresent
                                )}
                            </span>
                        </td>
                        <td>
                            <span data-tip={getTipForField('lof_z')}>
                                {falsyZeroCheck(
                                    shortenToSignificantDigits(lof_z),
                                    fallbackNotPresent
                                )}
                            </span>
                        </td>
                    ...
                    <tr>
                        <td className="text-600 text-left">
                            ...
                            <QuickPopover
                                popID="gene_loeuf"
                                className="p-0 icon-sm ml-02">
                                {genePopoverContents.loeuf}
                            </QuickPopover>
                        </td>
                        <td>{fallbackNotImplemented}</td>
                        <td>{fallbackNotImplemented}</td>
                        <td>
                            <span data-tip={getTipForField('oe_lof_upper')}>
                                {falsyZeroCheck(
                                    oe_lof_upper,
                                    fallbackNotPresent
                                )}
                    ...
                    <tr>
                        <td className="text-600 text-left">
                            ...
                            <QuickPopover
                                popID="gene_shet"
                                className="p-0 icon-sm ml-02">
                                {genePopoverContents.shet}
                            </QuickPopover>
                        </td>
                        <td>{fallbackNotImplemented}</td>
                        <td>{fallbackNotImplemented}</td>
                        <td>
                            <span data-tip={getTipForField('s_het')}>
                                {falsyZeroCheck(
                                    shortenToSignificantDigits(s_het),
                                    fallbackNotPresent
                                )}
                            </span>
                        </td>
                    ...
                    <tr>
                        <td className="text-600 text-left">
                            ...
                            <QuickPopover
                                popID="gene_rvis"
                                className="p-0 icon-sm ml-02">
                                {genePopoverContents.rvis}
                            </QuickPopover>
                        </td>
                        <td>{fallbackNotImplemented}</td>
                        <td>
                            <span data-tip={getTipForField('rvis_exac')}>
                                {falsyZeroCheck(
                                    shortenToSignificantDigits(rvis_exac),
                                    fallbackNotPresent
                                )}
                            </span>
                        </td>
...
export function ClinVarSection({
    context,
    getTipForField,
    schemas,
    clinvarExternalHref,
    ...
    const clinvarVariantSearchUrl = useMemo(
        function () {
            if (!CHROM && !POS) {
                return null;
            }
    ...
    const { result: { [variationID]: clinVarResult } = {} } =
        currentClinVarResponse || {};
    const {
    ...
    const lastEvaluatedFromClinVar = Date.parse(
        new Date(lastEvaluatedFromClinVarRaw)
    );

    const externalLinkIconAppend = (
        <i className="icon icon-external-link-alt fas ml-07 text-smaller text-secondary" />
    );
    ...
    if (!variationID) {
        ...
        return (
            <div className="d-flex align-items-center justify-content-center h-100 flex-column">
                {clinVarSearchLink ? (
                    <div className="my-2 flex-grow-1 w-100 text-left">
                        {clinVarSearchLink}
                    </div>
                ) : null}
                <h4 className="font-italic text-400 my-0 pb-24 flex-grow-1">
    ...
    return (
        <React.Fragment>
            <div className="mb-12">
                <label
                    data-tip={getTipForField('csq_clinvar')}
                    className="mb-0 d-inline">
                    ID:{' '}
                </label>
                {clinvarExternalHref ? (
                    <a
                        href={clinvarExternalHref}
                        target="_blank"
                        rel="noopener noreferrer"
                        data-tip="View this variant in ClinVar">
                        {variationID}
                        {externalLinkIconAppend}
                    </a>
                ) : (
            ...
            <div className="row mt-03">
                <div className="col-3">
                    <label
                        data-tip={getTipForField('csq_clinvar_clnsig')}
                        className="mb-0">
                        Interpretation:{' '}
                    </label>
                </div>
                <div className="col-9">
                    {clinicalSignificanceFromClinVar ||
                        clinicalSignificanceFromVariant}
                </div>
            </div>
            ...
            <div className="row mt-03">
                <div className="col-3">
                    <label
                        data-tip={getTipForField('csq_clinvar_clnrevstat')}
                        className="mb-0">
                        Review Status:{' '}
                    </label>
                </div>
            ...
            {lastEvaluatedFromClinVar && !isNaN(lastEvaluatedFromClinVar) ? (
                <div className="row mt-03">
                    ...
                    <div className="col-9">
                        <LocalizedTime
                            timestamp={lastEvaluatedFromClinVar}
                            localize={false}
                        />
                    </div>
                </div>
 ...
 */
export function standardizeGnomadValue(
    value,
    fallbackElem = <em data-tip="Not Available"> - </em>
) {
    if (typeof value === 'number') return value;
    if (
        Array.isArray(value) &&
        _.every(value, function (v) {
...
export function GeneTranscriptDisplayTitle({ transcript, hideGene }) {
    ...
    const {
        ...
        csq_biotype = null,
        csq_gene: { display_title: geneDisplayTitle = null } = {},
    } = transcript;
    return (
        <React.Fragment>
            ...
            {!hideGene ? (
                <span className="text-400">
                    {' '}
                    ({geneDisplayTitle || <em>No Gene</em>})
                </span>
            ) : null}
            {csq_canonical ? (
                <span
                    className="text-400 ml-05 text-muted small"
                    data-tip="Canonical Transcript">
...
export function getMostSevereConsequence(csq_consequence = []) {
    ...
    const [mostSevereConsequence] = csq_consequence
        .slice()
        .sort(function ({ impact: iA }, { impact: iB }) {
...
export function getTranscriptLocation(
    transcript,
    ...
    const consequenceName =
        (typeof var_conseq_name === 'string' &&
            var_conseq_name.toLowerCase()) ||
        null;

    let returnString = null;

    if (csq_exon !== null) {
        // In case csq_exon is `0` or something (unsure if possible)
...
const genePopoverContents = {
    expected: (
        <p>
            Expected variant counts (from gnomAD) for each mutation class.{' '}
            {linksToGnomad}
        </p>
    ),
    observed: (
        <p>
            Observed variant counts (from gnomAD) for each mutation class.{' '}
            {linksToGnomad}
        </p>
    ),
    oerange: (
        <p>
            Quotient of observed variant counts over expected variant counts
            (from gnomAD) for each variant class. {linksToGnomad}
        </p>
    ),
    zscore: (
        <p>
            Z-score for observed vs expected variant counts (from gnomAD) for
            each variant class. {linksToGnomad}
        </p>
    ),
    loeuf: (
        <p>
            Loss-of-function observed/expected upper bound fraction; a metric
            that is developed by the gnomAD team and supersedes pLI. Applicable
            to LoF variants only. {linksToGnomad}
        </p>
    ),
    shet: (
        <p>
            S-het is a score representing an estimate of the genome-wide
            distribution of selective effects for heterozygous protein
            truncating variants. Applicable to LoF variants only. For more
            information, see{' '}
            <a
                href="https://doi.org/10.1038/s41586-020-2308-7"
                target="_blank"
    ...
    rvis: (
        <p>
            Residual Variation Intolerance Score, a gene-based score formulated
            based on allele frequency data in the ExAC cohort. Applicable to
            missense variants only.&nbsp; A positive score indicates more common
            functional variation in the gene compared to genome-wide
            expectation; a negative score indicates less functional variation or
            intolerance to variation.&nbsp; More information available at{' '}
            <a
                href="http://genic-intolerance.org/about"
                target="_blank"
                rel="noreferrer">
                http://genic-intolerance.org/about
            </a>
            .
        </p>
    ),
