                        ...
                        <div className="info-body">
                            <div className="row mb-03">
                                <div className="col-12 col-xl-2">
                                    <label
                                        htmlFor="what_fields_is_this_idk"
                                        className="mb-0">
                                        gDNA:
                                    </label>
                                </div>
                            ...
                            <div className="row mb-03">
                                <div className="col-12 col-xl-2">
                                    <label
                                        htmlFor="variant.ID"
                                        className="mb-0"
                                        data-tip={getTipForField('variant.ID')}>
                                        dbSNP:
                                    </label>
                                </div>
                                {/**
...
function TranscriptSelectionSection(props) {
    ...
    const selectedGeneTranscript =
        geneTranscriptList[currentTranscriptIdx] || null;
    const selectedGeneTitle = (
        <GeneTranscriptDisplayTitle transcript={selectedGeneTranscript} />
    );
    ...
    if (geneTranscriptListLen === 0) {
        ...
        dropdownTitleToShow = selectedGeneTranscript ? (
            <span>
                {selectedGeneTitle}
                {currentGeneItemLoading ? (
                    <i className="ml-07 icon icon-spin fas icon-circle-notch" />
                ) : null}
            </span>
        ) : (
        ...
        body = (
            <TranscriptSelectionSectionBody
                {...{ schemas }}
                currentTranscript={geneTranscriptList[currentTranscriptIdx]}
            />
        );
    }
        ...
        <div className="inner-card-section col-12 col-xl pb-xl-2">
            <div className="info-header-title">
                ...
                <DropdownButton
                    ...
                    size="lg py-1"
                    variant="outline-secondary select-transcript"
                    onSelect={onSelectTranscript}
                    disabled={geneTranscriptListLen === 0}
                    data-tip="Select a transcript (& gene) to view their details">
                    {geneListOptions}
                </DropdownButton>
...
function TranscriptSelectionSectionBody({ schemas, currentTranscript }) {
    ...
    const {
        ...
        csq_exon = null,
        csq_gene: { display_title: currentGeneDisplayTitle = null } = {},
        csq_consequence = [],
    } = currentTranscript || {};
    ...
    const mostSevereConsequence = useMemo(
        function () {
    ...
    const { display_title: consequenceTitle = fallbackElem } =
        mostSevereConsequence || {};
            ...
            <div className="col-5">
                ...
                <div className="row mb-03">
                    <div className="col-12 col-lg-5 col-xl-6">
                        <label
                            htmlFor="calculated_transcript_location"
                            className="mb-0">
                            Location:
                        </label>
                    </div>
                    <div
                        ...
                        id="calculated_transcript_location">
                        {transcriptLocation}
                    </div>
                </div>
                ...
                <div className="row mb-03">
                    <div className="col-12 col-lg-5 col-xl-6">
                        <label
                            htmlFor="variant.transcript.csq_consequence"
                            className="mb-0"
                            data-tip={getTipForField(
                                'transcript.csq_consequence'
                            )}>
                            Consequence:
                        </label>
                    </div>
                    <div
                        className="col-12 col-lg-auto"
                        id="variant.transcript.csq_consequence">
                        {consequenceTitle}
                    </div>
                </div>
            </div>
            ...
            <div className="col-7">
                ...
                <div className="row mb-03">
                    <div className="col-12 col-lg-4 col-xl-4">
                        <label
                            htmlFor="variant.transcript.csq_gene.display_title"
                            className="mb-0"
                            data-tip={getTipForField('transcript.csq_gene')}>
                            Gene:
                        </label>
                    </div>
                    {/**
                    ...
                    <div
                        className="col-12 col-lg-auto"
                        id="variant.transcript.csq_gene.display_title">
                ...
                <div className="row mb-03">
                    <div className="col-12 col-lg-4 col-xl-4">
                        <label
                            htmlFor="csq_hgvsc"
                            className="mb-0"
                            data-tip={getTipForField('transcript.csq_hgvsc')}>
                            cDNA:
                        </label>
                    </div>
                    <div
                        className="col-12 col-lg-auto"
                        id="variant.transcript.csq_hgvsc">
                        {csq_hgvsc}
                    </div>
                </div>
                ...
                <div className="row mb-03">
                    <div className="col-12 col-lg-4 col-xl-4">
                        <label
                            htmlFor="csq_hgvsp"
                            className="mb-0"
                            data-tip={getTipForField('transcript.csq_hgvsp')}>
                            AA / AA:
                        </label>
                    </div>
                    <div
                        className="col-12 col-lg-auto"
                        id="variant.transcript.csq_hgvsp">
                        {csq_hgvsp}
                    </div>
                </div>
            </div>
...
const hg19PopoverTitle =
    'The HGVS-formatted variant in hg19 coordinates is calculated.';
const hg19PopoverContent = (
    <div>
        ...
        <p>
            To calculate the variant for hg19 coordinates, the hg38 position is
            converted to hg19 via an implementation of{' '}
            <a href="https://github.com/konstantint/pyliftover">LiftOver</a>. If
            the hg19 conversion is successful, the variant is then converted to
            HGSV format. If the HGSV conversion is also successful, the result
            will be displayed. Otherwise, only the hg38 coordinates for the
