...
export const CaseSpecificSelectionsPanel = React.memo(
    function CaseSpecificSelectionsPanel(props) {
        ...
        return (
            ...
            <div className={'card' + (className ? ' ' + className : '')}>
                <button
                    type="button"
                    className={
                        'card-header btn py-3 bg-primary-dark' +
                        (!isExpanded ? ' rounded' : '')
                    }
                        ...
                        <div className="card-body">
                            <div className="mb-08">
                                <DropdownButton
                                    ...
                                    <DropdownItem
                                        eventKey={panels.ACMG}
                                        active={showingPanel === panels.ACMG}>
                                        {panelTitles[panels.ACMG]}
                                    </DropdownItem>
                                    <DropdownItem
                                        eventKey={panels.GENEDISCOVERY}
                                        active={
                                            showingPanel ===
                                            panels.GENEDISCOVERY
                                        }>
...
export class NoteSubSelectionStateController extends React.PureComponent {
    constructor(props) {
        ...
        this.toggleReportNoteSubselectionState =
            this.toggleNoteSubselectionState.bind(this, 'reportNotesIncluded');
        this.toggleKBNoteSubselectionState =
            this.toggleNoteSubselectionState.bind(this, 'kbNotesIncluded');
...
const ACMGClassificationSelections = React.memo(
            ...
            <div className="row">
                <div className="col-12 col-lg-6">
                    ...
                    <ACMGClassificationSelectionsCommonCheckboxList
                        variantSampleListItem={variantSampleListItem}
                        store={sendToReportStore}
                        toggleItems={toggleSendToReportStoreItems}
                        noteTypesIncluded={reportNotesIncluded}
                        alreadySaved={alreadyInReportNotes}
                    />
                </div>
                <div className="col-12 col-lg-6">
                    ...
                    <ACMGClassificationSelectionsCommonCheckboxList
                        variantSampleListItem={variantSampleListItem}
                        store={sendToProjectStore}
                        toggleItems={toggleSendToProjectStoreItems}
                        noteTypesIncluded={kbNotesIncluded}
                        alreadySaved={alreadyInProjectNotes}
                    />
                </div>
            </div>
        );
...
function ACMGClassificationSelectionsCommonCheckboxList({
    store,
    toggleItems,
    variantSampleListItem,
    alreadySaved,
    ...
    const variantSamplesWithInterpretationClassification = useMemo(
        function () {
    ...
    const onChange = useCallback(
        function onChange(evt) {
            ...
            if (currentChecked) {
                ...
                objectsToToggle = activeSelectionsByClassification[eventKey]
                    .reduce(function (m, { variant_sample_item }) {
                ...
                objectsToToggle = inactiveSelectionsByClassification[eventKey]
                    .reduce(function (m, { variant_sample_item }) {
                        // Toggle only the yet-unselected note uuids, filtered by `noteTypesIncluded`.
                        const noteUUIDsToSelect = getAllNotesFromVariantSample(
                            variant_sample_item,
                            noteTypesIncluded
                        )
                            .map(function ({ uuid }) {
        ...
        [checkboxStates, store, noteTypesIncluded]
    ); // If reference to checkboxStates changes, we assume same is true for the rest of its memoized return neighbors.
...
function VariantGeneSelectionsCommonCheckboxList({
    store,
    toggleItems,
    variantSampleListItem,
    alreadySaved,
    ...
    const variantSamplesWithGeneCandidacy = useMemo(
        function () {
    ...
    const variantSamplesWithVariantCandidacy = useMemo(
        function () {
            // Ignore VSes with no discoveryInterpretationNote saved
            return variant_samples.filter(function (vsSelection) {
                const {
    ...
    const {
        ...
        inactiveSelectionsByClassification:
            geneInactiveSelectionsByClassification,
    ...
    const {
        ...
        activeSelectionsByClassification:
            variantActiveSelectionsByClassification,
        inactiveSelectionsByClassification:
            variantInactiveSelectionsByClassification,
    ...
    const onChange = useCallback(
        function onChange(evt) {
            const eventKey = evt.target.getAttribute('data-key');
            const candidacyType = evt.target.getAttribute(
                'data-candidacy-type'
            );
            ...
            if (candidacyType === 'gene') {
                checkboxStates = geneCheckboxStates;
                activeSelectionsByClassification =
                    geneActiveSelectionsByClassification;
                inactiveSelectionsByClassification =
                    geneInactiveSelectionsByClassification;
            } else {
                checkboxStates = variantCheckboxStates;
        ...
        [geneCheckboxStates, variantCheckboxStates, store, noteTypesIncluded]
    ); // If reference to checkboxStates changes, we assume same is true for the rest of its memoized return neighbors.

    const commonGeneCandidacyProps = {
        onChange,
        'data-candidacy-type': 'gene',
        checkboxStates: geneCheckboxStates,
        indeterminateStates: geneIndeterminateStates,
        classificationCounts: geneClassificationCounts,
        ignoredCounts: geneIgnoredCountsByClassification,
    ...
    return (
        <div className="px-2">
            <KeyedCheckbox
                data-key="Strong candidate"
                {...commonGeneCandidacyProps}>
                Strong Candidate Genes
            </KeyedCheckbox>
            <KeyedCheckbox
                data-key="Moderate candidate"
                {...commonGeneCandidacyProps}>
                Moderate Candidate Genes
            </KeyedCheckbox>
            <KeyedCheckbox
                data-key="Weak candidate"
                {...commonGeneCandidacyProps}>
            ...
            <div className="row">
                <div className="col-12 col-lg-6">
                    ...
                    <NoteTypeSelectionsCommonCheckboxList
                        ...
                        store={sendToReportStore}
                        toggleItems={toggleSendToReportStoreItems}
                        noteTypesIncludedState={reportNotesIncluded}
                        toggleNoteTypesIncludedState={
                            toggleReportNoteSubselectionState
                        }
                    />
                </div>
                <div className="col-12 col-lg-6">
                    ...
                    <NoteTypeSelectionsCommonCheckboxList
                        ...
                        store={sendToProjectStore}
                        toggleItems={toggleSendToProjectStoreItems}
                        noteTypesIncludedState={kbNotesIncluded}
                        toggleNoteTypesIncludedState={
                            toggleKBNoteSubselectionState
                        }
                    />
...
function NoteTypeSelectionsCommonCheckboxList(props) {
    ...
    const variantSampleObjectsSelected = useMemo(
        function () {
    ...
    const {
        ...
        function () {
            return getClassificationStates(
                ...
                function (enumOption, vsSelection) {
                    const {
                        variant_sample_item: { [enumOption]: foundNote = null },
                    } = vsSelection;
                    return !!foundNote;
                },
                store,
...
function KeyedCheckbox(props) {
    ...
    const checked =
        checkboxStates[key] ||
        (disableOnNoClassificationsCount &&
            classificationCounts[key] === 0 &&
            ignoredCounts[key] > 0);
    const disabled =
        propDisabled ||
        (disableOnNoClassificationsCount && classificationCounts[key] === 0);
    const countAddendum =
        classificationCounts &&
        typeof classificationCounts[key] === 'number' ? (
            <React.Fragment>
                &nbsp;
    ...
    return (
        <div className={cls}>
            <Checkbox
                ...
                disabled={disabled}
                indeterminate={indeterminateStates[key]}>
                {children}
                {countAddendum}
            </Checkbox>
        </div>
...
export function getAllNotesFromVariantSample(
    variantSampleItem,
    ...
    if (
        include.discovery_interpretation &&
        discovery_interpretation !== null &&
...
function getClassificationStates(
    ...
    viableVariantSampleSelections.forEach(function (vsSelection) {
        ...
        possibleEnums.forEach(function (enumOption) {
            ...
            const currentNotes = getAllNotesFromVariantSample(
                vsItem,
                noteTypesIncluded
            ...
            const isSelected = _.every(currentNotes, function ({ uuid }) {
                return store[uuid];
            });
            ...
            if (isSelected) {
                ...
                inactiveSelectionsByClassification[enumOption].push(
                    vsSelection
                );
