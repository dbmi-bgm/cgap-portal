...
import {
    ...
    flattenColumnsDefinitionsSortFields,
...
export function CaseViewEmbeddedVariantSampleSearchTable(props) {
    const {
        ...
        columnExtensionMap: originalColExtMap = EmbeddedItemSearchTable
            .defaultProps.columnExtensionMap,
        ...passProps
    } = props;

    const columnExtensionMap = useMemo(
        function () {
            return {
                ...originalColExtMap,
                display_title: {
    ...
    return (
        <CaseViewEmbeddedVariantSampleSearchTableBase
            {...passProps}
...
export function CaseViewEmbeddedVariantSampleSearchTableBase(props) {
    ...
    const technicalReviewCommonProps = {
        setOpenPopoverData,
        cacheSavedTechnicalReviewForVSUUID,
        cacheUnsavedTechnicalReviewNoteTextForVSUUID,
        haveCaseEditPermission,
    };
    const interpretationSelectionCommonProps = {
        selectedVariantSamples,
        onSelectVariantSample,
        savedVariantSampleIDMap,
        isLoadingVariantSampleListItem,
            ...
            return {
                ...
                'technical_review.assessment.call': {
                    ...
                    render: function (result, propsFromSearchTable) {
                        ...
                        const lastSavedTechnicalReviewForResult =
                            lastSavedTechnicalReview[vsUUID];
                        const unsavedTechnicalReviewNoteTextForResult =
                            unsavedTechnicalReviewNoteTexts[vsUUID];
                        return (
                            <TechnicalReviewColumn
                                {...technicalReviewCommonProps}
                                {...{
                                    result,
                ...
                interpretation_selection: {
                    ...
                    render: function (result, props) {
                        return (
                            <VariantSampleSelectionCheckbox
                                {...interpretationSelectionCommonProps}
                                result={result}
                            />
                        );
                    },
                ...
                __matching_filter_block_names: {
                    ...
                    colTitle: (
                        <i className="icon icon-fw icon-object-ungroup far" />
                    ),
                    render: function (result, props) {
                        ...
                        return (
                            <MatchingFilterBlockIndicesPopoverColumn
                                {...{ currFilterSet, result }}
                            />
                        );
                    },
                },
    ...
    return (
        <React.Fragment>
            <TechnicalReviewPopoverOverlay
                {...{ openPopoverData, setOpenPopoverData }}
            />
...
const TechnicalReviewPopoverOverlay = React.memo(
    function TechnicalReviewPopoverOverlay({
        openPopoverData,
        setOpenPopoverData,
    }) {
        const { ref: openPopoverRef = null, jsx: openPopoverJSX = null } =
            openPopoverData || {};
        ...
        const onRootClickHide = useCallback(function (e) {
            ...
            if (
                e.target &&
                e.target.getAttribute('data-technical-review') === 'true'
            ) {
                return false;
            }
            if (
                ...
                e.target.parentElement.getAttribute('data-technical-review') ===
                    'true'
            ) {
                return false;
            }
        ...
        return (
            <Overlay
                target={openPopoverRef}
                show={!!openPopoverData}
                transition={false}
                placement="bottom"
                rootClose
...
export const VariantSampleSelectionCheckbox = React.memo(
    function VariantSampleSelectionCheckbox(props) {
        const {
            selectedVariantSamples,
            result,
            onSelectVariantSample,
...
const MatchingFilterBlockIndicesPopoverColumn = React.memo(
    function MatchingFilterBlockIndicesPopoverColumn(props) {
        ...
        const filterBlockNameList = __matching_filter_block_names.map(function (
            fbIdx,
            idxIdx
        ) {
