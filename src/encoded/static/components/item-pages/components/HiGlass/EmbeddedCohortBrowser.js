        ...
        if (hgc) {
            ...
            viewconfCohort.views[0].tracks.top.forEach((track) => {
                ...
                if (track.uid === 'texttrack_genelist') {
                    if (selectedGenes === 'all') {
                        track.options['text'] =
                            'Selected genes: all coding genes';
                    } else {
                ...
                <ul className="nav nav-tabs" role="tablist">
                    <li className="nav-item" key="cohort">
                        <a
                            ...
                            onClick={(evt) =>
                                this.handleTabClick(evt, 'cohort')
                            }
                            href="#">
                            Cohort Browser
                        </a>
                    ...
                    <li className="nav-item" key="annotation">
                        <a
                            ...
                            onClick={(evt) =>
                                this.handleTabClick(evt, 'annotation')
                            }
                            href="#">
                            Annotation Browser
                        </a>
                ...
                <div className="tab-content" id="cohortTabContent">
                    ...
                    />
                                    ...
                                    <MaskFilter
                                        ...
                                        onChange={this.applyMaskFilter.bind(
                                            this
                                        )}
                                    />
                                    ...
                                    <ControlFilter
                                        ...
                                        onChange={this.applyControlFilter.bind(
                                            this
                                        )}
                                    />
                            ...
                            <div className="col-sm-9">
                                <HiGlassAjaxLoadContainer
                                    cohortVariantTestResults={
                                        this.cohortVariantTestResults
                                    }
                                    cohortGeneTestResults={
                                        this.cohortGeneTestResults
                                    }
                                    cohortVariantDensity={
                                        this.cohortVariantDensity
                                    }
                                    variantDetailSource={
                                        this.variantDetailSource
                                    }
