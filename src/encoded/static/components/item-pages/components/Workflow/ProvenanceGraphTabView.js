...
export const ProvenanceGraphTabView = React.memo(
    function ProvenanceGraphTabView(props) {
        const {
            heading,
            graphSteps = null,
                ...
                <div>
                    ...
                    <div className="container-wide text-center">
                        {isLoadingGraphSteps ? (
                            ...
                            <h5 className="text-400">No steps available</h5>
                        )}
                    </div>
                </div>
            );
            ...
            <div>
                <h3 className="tab-section-title container-wide">
                    ...
                    <WorkflowGraphSectionControls
                        ...
                        includeAllRunsInSteps={
                            anyGroupNodes || includeAllRunsInSteps
                                ? includeAllRunsInSteps
                                : null
                        }
                        rowSpacingTitleMap={
                            ProvenanceGraphOptionsStateController.rowSpacingTitleMap
                        }
                    />
                </h3>
                <hr className="tab-section-title-horiz-divider" />
                <GraphParser
                    parsingOptions={parsingOptsForGraph}
                    parentItem={lastStep}
                    steps={graphSteps}>
                    <Graph {...graphProps} />
                </GraphParser>
...
ProvenanceGraphTabView.getTabObject = function (props) {
    const { windowWidth, windowHeight, isLoadingGraphSteps, graphSteps } =
        props;
