    ...
    static defaultProps = {
        items: {
            ...
            'Group of Similar Files': {
                ...
                tooltip:
                    'Grouping of similar files, e.g. those which are generated from different runs of the same <em>workflow</em>.',
            },
            ...
            'Intermediate File': {
                ...
                tooltip:
                    'File that was generated in the Workflow but perhaps not saved or important.',
            },
            //'Unsaved File'              : { className: 'node-disabled' },
            'Current Context': {
                className: 'node-type-global-context',
                tooltip:
                    "Files which are contextual to the Item you're viewing, e.g. terminal processed files from an Experiment Set.",
            },
        },
        title: 'Graph Legend',
    };
        ...
        return (
            <div className="workflow-legend-container overflow-hidden mt-1">
                <div className="inner">
                    ...
                    {_.map(_.pairs(items), ([itemTitle, details]) => (
                        <LegendItem
                            {...details}
                            title={itemTitle}
                            key={itemTitle}
