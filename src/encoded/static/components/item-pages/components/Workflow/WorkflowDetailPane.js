...
export const WorkflowDetailPane = React.memo(function WorkflowDetailPane(
    props
) {
    ...
    return (
        <div
            className="detail-pane-container has-selected-node"
            style={{ minHeight }}>
        ...
        <React.Fragment>
            <div className="title-box row">
                ...
                <div className="col-auto">
                    <i
                        className="icon icon-times fas clickable"
