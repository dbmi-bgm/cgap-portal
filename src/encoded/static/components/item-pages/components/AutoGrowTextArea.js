...
export class AutoGrowTextArea extends React.Component {
    ...
    componentDidUpdate(pastProps) {
        const { maxHeight: pastMaxHeight, visible: pastVisible = true } =
            pastProps;
        ...
        if (visible === false && pastVisible === true) {
            ...
            (visible === true && pastVisible === false) ||
            maxHeight !== pastMaxHeight
        ) {
    ...
    resizeToFitContent() {
        ...
        this.setState(
            function ({ textAreaHeight: existingTextAreaHeight }) {
            ...
            () => {
                const newScrollHeight =
                    this.textAreaRef.current.scrollHeight + buffer;
                this.setState({
                    parentHeight:
    ...
    render() {
        ...
        return (
            ...
            <div
                style={this.memoized.textareaWrapperStyle(
                    parentHeight,
                    maxHeight
                )}
                className={className}>
                <textarea
                    ...
                    style={this.memoized.textareaStyle(
                        textAreaHeight,
                        maxHeight
                    )}
