...
export const SvSampleTabBody = (props) => {
    ...
    function getTipForField(
        field,
        itemType = 'StructuralVariantSample',
        nestedField = ''
    ) {
        ...
        <div className="sample-tab-body card-body">
                ...
                <div className="inner-card-section col pb-2 pb-lg-0">
                    <div className="info-header-title">
                        <h4>
                            ...
                            <a
                                href="https://cgap-pipeline-main.readthedocs.io/en/latest/Pipelines/Downstream/SV_germline/overview-SV_germline.html"
                                rel="noopener noreferrer"
                                target="_blank"
                                className="px-1"
                                data-tip="View Manta Documentation">
                ...
                <div className="inner-card-section col mt-2 pb-2 pb-lg-0">
                    <div className="info-header-title">
                        <h4>
                            ...
                            <a
                                href="https://cgap-pipeline-main.readthedocs.io/en/latest/Pipelines/Downstream/CNV_germline/overview-CNV_germline.html"
                                rel="noopener noreferrer"
                                target="_blank"
                                className="px-1"
                                data-tip="View BIC-seq2 Documentation">
                                <i className="icon icon-external-link-alt fas ml-07 text-small" />
                            </a>
                        </h4>
                    </div>
            ...
            <div className="row flex-column flex-lg-row">
                <div className="inner-card-section col mt-2 pb-2 pb-lg-0">
                    ...
                    <div className="info-body">
                        <GenotypeQualityTable
                            {...{ context, getTipForField }}
                        />
                    </div>
                </div>
            </div>
...
function SvMantaTable(props) {
    ...
    if (!callers.length || !callers.includes('Manta')) {
        return (
            <div className="font-italic text-larger text-center py-4">
    ...
    return (
        <div className="table-responsive">
            <table className="w-100">
                <thead>
                    <tr>
                        <th className="text-left" style={{ width: '385px' }}>
                            Quality
                        </th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td className="text-left">
                            {getTipForField('imprecise')}
                        </td>
                    </tr>
                    <tr>
                        <td className="text-600 text-left">
                            Confidence interval around left breakpoint
                        </td>
                        <td className="text-left">
                            {startExists
                                ? confidence_interval_start.join(', ')
                                : fallbackElem}
                        </td>
                        <td className="text-left">
                            {getTipForField(
                    ...
                    <tr>
                        <td className="text-600 text-left">
                            Confidence interval around right breakpoint
                        </td>
                        <td className="text-left">
                            {endExists
                                ? confidence_interval_end.join(', ')
                                : fallbackElem}
                        </td>
                        <td className="text-left">
                            {getTipForField(
                    ...
                    <tr>
                        <td className="text-600 text-left">
                            Number of split reads supporting the alternative
                            allele
                        </td>
                        <td className="text-left">
                            {falsyZeroCheck(
                    ...
                    <tr>
                        <td className="text-600 text-left">
                            Number of split reads supporting the reference
                            allele
                        </td>
                        <td className="text-left">
                            {falsyZeroCheck(
                    ...
                    <tr>
                        <td className="text-600 text-left">
                            Number of spanning reads supporting the alternative
                            allele
                        </td>
                        <td className="text-left">
                            {falsyZeroCheck(
                    ...
                    <tr>
                        <td className="text-600 text-left">
                            Number of spanning reads supporting the reference
                            allele
                        </td>
                        <td className="text-left">
                            {falsyZeroCheck(
                    ...
                    <tr>
                        ...
                        <td className="text-left">
                            {falsyZeroCheck(qualityScore, fallbackElem)}
                        </td>
                        <td className="text-left">
                            {getTipForField(
                                'quality_score',
            ...
            <table className="w-100">
                ...
                <tbody>
                    <tr>
                        ...
                        <td className="text-left">
                            {bicseq2_observed_reads || fallbackElem}
                        </td>
                        <td className="text-left">
                            {getTipForField('bicseq2_observed_reads')}
                        </td>
                    </tr>
                    <tr>
                        <td className="text-600 text-left">
                            Number of Expected Reads
                        </td>
                        <td className="text-left">
                            {bicseq2_expected_reads || fallbackElem}
                        </td>
                        <td className="text-left">
                            {getTipForField('bicseq2_expected_reads')}
                        </td>
                    </tr>
                    <tr>
                        <td className="text-600 text-left">
                        ...
                        <td className="text-left">
                            <div className="text-nowrap mr-1">
                                {shortenToSignificantDigits(
                                    bicseq2_log2_copy_ratio
                                ) || fallbackElem}
                                <i
                                    className="ml-02 font-xs icon icon-info-circle fas"
                                    data-html
                                    data-tip={`
                        ...
                        <td className="text-left">
                            {getTipForField('bicseq2_log2_copy_ratio')}
                        </td>
                    </tr>
                    <tr>
                        <td className="text-600 text-left">P-value</td>
                        <td className="text-left">
                            {shortenToSignificantDigits(bicseq2_pvalue, 2) ||
                                fallbackElem}
                        </td>
                        <td className="text-left">
                            {getTipForField('bicseq2_pvalue')}
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    const rows = samplegeno.map((sg) => {
        ...
        return (
            <tr key={samplegeno_sampleid + samplegeno_role}>
                <td className="text-capitalize text-left text-truncate">
                    {samplegeno_role}
                </td>
                        ...
                        <th className="text-left">
                            ...
                            <i
                                ...
                                data-tip={getTipForField(
                                    'samplegeno',
                                    'StructuralVariantSample',
                                    'items.properties.samplegeno_numgt'
                                )}
                            />
                        </th>
                        <th className="text-left">
                            ...
                            <i
                                ...
                                data-tip={getTipForField(
                                    'samplegeno',
                                    'StructuralVariantSample',
                                    'items.properties.samplegeno_quality'
                                )}
                            />
                        </th>
                        <th className="text-left">
                            ...
                            <i
                                ...
                                data-tip={getTipForField(
                                    'samplegeno',
                                    'StructuralVariantSample',
                                    'items.properties.samplegeno_likelihood'
                                )}
                            />
                        </th>
                    </tr>
