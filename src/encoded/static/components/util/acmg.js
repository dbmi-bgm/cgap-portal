...
export const metadata = {
    ...
    "BP2": { type: "benign", strength: "Supporting", order: 3, description: "Observed in <span class='fst-italic'>trans</span> with a pathogenic variant for a fully penetrant dominant gene/disorder or observed in <span class='fst-italic'>cis</span> with a pathogenic variant in any inheritance pattern" },
    ...
    "PM3": { type: "pathogenic", strength: "Moderate", order: 5, description: "For recessive disorders, detected in <span class='fst-italic'>trans</span> with a pathogenic variant<br/><br/><em>Note: This requires testing of parents (or offspring) to determine phase.</em>" },
