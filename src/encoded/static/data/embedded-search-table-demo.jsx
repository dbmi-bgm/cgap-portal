...
<div key="someRandomKey">
    ...
    <pre className="border rounded px-3 py-2">{'<EmbeddedItemSearchTable\n    searchHref="/search/?type=File&file_format.file_format=bam&status=released"\n    schemas={schemas}\n    session={session}\n    hideFacets={["type", "validation_errors.name", "status", "file_format.file_format", "file_type"]}\n/>'}</pre>
