...
travis-test:
	bin/test -vv --timeout=200 -m "working and not performance" --aws-auth --durations=10 --cov src/encoded --es search-cgap-testing-ud3ggpjj7x6vclx62nmzymyzfi.us-east-1.es.amazonaws.com:80
