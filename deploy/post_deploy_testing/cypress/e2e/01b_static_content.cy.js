        ...
        cy.get('#help-menu-item')
            ...
            .then(() => {
                cy.get(
                    ...
                    var allLinkElementIDs = Cypress._.map(
                        listItems,
                        function (liEl) {
                    ...
                    cy.get('#page-title-container span.title')
                        .should('have.text', '4D Nucleome Data Portal')
                        .then((title) => {
                            ...
                            function doVisit(listItem) {
                                ...
                                cy.wait(300)
                                    .get('#page-title-container span.title')
                                    ...
                                    .then((t) => {
                                        ...
                                        cy.title()
                                            .should(
                                                'equal',
                                                titleText + ' – 4DN Data Portal'
                                            )
                                            .end(); // Ensure <head>...<title>TITLE</title>...</head> matches.
                                        prevTitle = titleText;
